...
event_fillers["on_cutscene_finished"] = function(event)
    local player = game.get_player(event["player_index"])
    if player ~= nil then
        event["player"] = data_fillers["player"](player)
    end
...
event_fillers["on_cutscene_started"] = function(event)
    local player = game.get_player(event["player_index"])
    if player ~= nil then
        event["player"] = data_fillers["player"](player)
    end
...
event_fillers["on_entity_color_changed"] = function(event)
    event["entity"] = data_fillers["entity"](event["entity"])
    return event
end
...
event_fillers["on_gui_hover"] = function(event)
    event["element"] = data_fillers["gui_element"](event["element"])
    local player = game.get_player(event["player_index"])
    if player ~= nil then
        event["player"] = data_fillers["player"](player)
...
event_fillers["on_gui_leave"] = function(event)
    event["element"] = data_fillers["gui_element"](event["element"])
    local player = game.get_player(event["player_index"])
    if player ~= nil then
        event["player"] = data_fillers["player"](player)
...
event_fillers["on_player_alt_reverse_selected_area"] = function(event)
    local player = game.get_player(event["player_index"])
    if player ~= nil then
        event["player"] = data_fillers["player"](player)
    end
...
event_fillers["on_player_input_method_changed"] = function(event)
    local player = game.get_player(event["player_index"])
    if player ~= nil then
        event["player"] = data_fillers["player"](player)
    end
...
event_fillers["on_player_reverse_selected_area"] = function(event)
    local player = game.get_player(event["player_index"])
    if player ~= nil then
        event["player"] = data_fillers["player"](player)
    end
...
event_fillers["on_pre_ghost_upgraded"] = function(event)
    event["ghost"] = data_fillers["entity"](event["ghost"])
    if event["player_index"] ~= nil then
        local player = game.get_player(event["player_index"])
        if player ~= nil then
...
event_fillers["on_research_cancelled"] = function(event)
    event["force"] = data_fillers["force"](event["force"])
    return event
end
...
event_fillers["script_raised_teleported"] = function(event)
    event["entity"] = data_fillers["entity"](event["entity"])
    return event
end
